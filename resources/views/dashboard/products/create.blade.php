...
<div class="max-w-3xl mx-auto space-y-6" dir="rtl">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold text-dark-100">إضافة منتج جديد</h1>
    </div>

    <form action="{{ route('dashboard.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="productForm()">
        @csrf
        ...
        <div class="bg-dark-900 rounded-2xl border border-dark-800 p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required class="w-full bg-dark-800 border border-dark-700 rounded-xl px-4 py-2.5 text-dark-100 text-sm focus:outline-none focus:border-blue-500 transition-colors" placeholder="أدخل اسم المنتج">
                @error('name')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="sku" value="{{ old('sku') }}" required class="w-full bg-dark-800 border border-dark-700 rounded-xl px-4 py-2.5 text-dark-100 text-sm focus:outline-none focus:border-blue-500 transition-colors" placeholder="مثال: PRD-001">
                    @error('sku')
                        <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="bg-dark-900 rounded-2xl border border-dark-800 p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="buy_price" step="0.01" min="0" value="{{ old('buy_price') }}" required x-model="buyPrice" class="w-full bg-dark-800 border border-dark-700 rounded-xl px-4 py-2.5 text-dark-100 text-sm focus:outline-none focus:border-blue-500 transition-colors" placeholder="0.00">
                    @error('buy_price')
                        <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="sell_price" step="0.01" min="0" value="{{ old('sell_price') }}" required x-model="sellPrice" class="w-full bg-dark-800 border border-dark-700 rounded-xl px-4 py-2.5 text-dark-100 text-sm focus:outline-none focus:border-blue-500 transition-colors" placeholder="0.00">
                    @error('sell_price')
                        <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="stock_quantity" min="0" value="{{ old('stock_quantity', 0) }}" required class="w-full bg-dark-800 border border-dark-700 rounded-xl px-4 py-2.5 text-dark-100 text-sm focus:outline-none focus:border-blue-500 transition-colors" placeholder="0">
                ...
                <div>
                    ...
                    <input type="number" name="low_stock_threshold" min="0" value="{{ old('low_stock_threshold', 5) }}" class="w-full bg-dark-800 border border-dark-700 rounded-xl px-4 py-2.5 text-dark-100 text-sm focus:outline-none focus:border-blue-500 transition-colors" placeholder="5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="weight" step="0.01" min="0" value="{{ old('weight') }}" class="w-full bg-dark-800 border border-dark-700 rounded-xl px-4 py-2.5 text-dark-100 text-sm focus:outline-none focus:border-blue-500 transition-colors" placeholder="0">
                    @error('weight')
                        <span class="text-red-400 text-sm mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-center gap-3">
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', 1) ? 'checked' : '' }} class="w-4 h-4 rounded bg-dark-800 border-dark-700 text-blue-600 focus:ring-blue-500">
        ...
        <div class="flex items-center justify-end gap-3">
            ...
            <button type="submit" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-medium transition-colors">إضافة المنتج</button>
        </div>
    </form>
</div>
